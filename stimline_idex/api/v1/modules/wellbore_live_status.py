...
class WellboreLiveStatuses:
    ...
    @overload
    def get(self, *, include_soft_delete: Optional[bool] = None) -> list[WellboreLiveStatus]: ...
    @overload
    def get(self, *, wellbore: Wellbore, include_soft_delete: Optional[bool] = None) -> list[WellboreLiveStatus]: ...
    @overload
    def get(self, *, wellbore_id: str, include_soft_delete: Optional[bool] = None) -> list[WellboreLiveStatus]: ...
